...
import DataOnTable from './subComponents/dataOnTable'
    ...
    return <div >
      ...
      <div>
        <p style={styles.listHead}>
          To protect yourself and your loved ones, it's very important to:
        </p>
  ...
  return (
    <div className="Home">
      <div className="home-left">
        ...
        {showMap && <DataOnMap showTab={false}></DataOnMap>}
        {!showMap && <DataOnTable showTab={false}></DataOnTable>}

        <button style={styles.mapButton} onClick={() => setshowMap(!showMap)}>
          {' '}
          {showMap ? 'View on Table' : 'View On Map'}
        </button>
        ...
        <div style={styles.summary}>
          ...
          {showMoreSummary && moreSummary()}
          <span style={styles.showMore} onClick={() => setShowMoreSummary(!showMoreSummary)} >{showMoreSummary ? '...show Less' : '...show more'}</span>
